...
async function TestContractEvents() {
    ...
    const running = new Promise(function (resolve, reject) {
        ...
        return Promise.all([
            ...
            waitForEvent("TestIndexedString", [
                { indexed: true, hash: "0x7c5ea36004851c764c44143b1dcb59679b11c9a68e5f41497f6cf3d480715331" },
                p1,
            ]),
...
describe("Test Contract Transaction Population", function () {
    ...
    it("standard population", async function () {
        ...
        assert.equal(
            tx.data,
            "0x70a08231000000000000000000000000deadbeef00deadbeef01deadbeef02deadbeef03",
            "data matches",
        );
